...
def plot_class_distribution(dataset, title):
    ...
    save_path = os.path.join(data_dir,"effnet-b4-10k", f"{title.lower()}_class_distribution_ripeness.png")
    plt.tight_layout()
...
def evaluate_model(model, test_loader, class_names):
    ...
    save_path = os.path.join(data_dir,"effnet-b4-10k", "confusion_matrix_ripeness.png")
    plt.tight_layout()
    plt.savefig(save_path)
    plt.close()
    print(f"Saved plot: {save_path}")
...
def train_model(num_epochs, patience=5):
    ...
    plt.legend()
    plt.grid(True)
    save_path = os.path.join(data_dir,"effnet-b4-10k", "val_loss_accuracy_curve_ripeness.png")
    plt.tight_layout()
    plt.savefig(save_path)
    plt.close()
    print(f"Saved plot: {save_path}")
    ...
    # Save best model
    file_path = os.path.join(data_dir,"effnet-b4-10k", "ripeness_b4.pth")
...
# ---- MAIN ----
def main():
    log_path = os.path.join(data_dir,"effnet-b4-10k", "log_ripeness.txt")
